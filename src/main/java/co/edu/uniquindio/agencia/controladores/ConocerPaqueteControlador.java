...
public class ConocerPaqueteControlador implements Initializable, CambioIdiomaListener {
    ...
    private PaqueteTuristico paqueteTuristico = agenciaCliente.getPaqueteTuristico();
    ...
    public void setPaqueteTuristico(PaqueteTuristico paqueteTuristico) {
        this.paqueteTuristico = agenciaCliente.getPaqueteTuristico();
    ...
    private void verDestino() {
        String destinoSeleccionado = cbxDestinos.getValue();

        if (destinoSeleccionado != null) {
            Destino destino = agenciaCliente.obtenerDestino(destinoSeleccionado);

            if (destino != null) {
                // Resto del código para mostrar detalles del destino
                ...
                // Manejo si el destino es nulo
                mostrarMensaje(Alert.AlertType.ERROR, "No se pudo obtener información del destino seleccionado.");
            }
        } else {
            // Manejo si el destino seleccionado es nulo
            mostrarMensaje(Alert.AlertType.ERROR, "Seleccione un destino antes de ver detalles.");
        }
    }
